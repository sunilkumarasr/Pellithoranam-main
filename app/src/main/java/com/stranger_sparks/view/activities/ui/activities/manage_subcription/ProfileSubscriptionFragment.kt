...
import com.stranger_sparks.databinding.FragmentProfileSubscriptionBinding
...
class ProfileSubscriptionFragment : Fragment(), OnItemClickListenerWithPosition {


    lateinit var binding: FragmentProfileSubscriptionBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentProfileSubscriptionBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //plan details
        viewModel.manageSubscriptionsV2(userID,"3")
        viewModel.manageSubscriptionV2LiveData.observe(requireActivity()){

            if(it?.status == true){

                if (it.data?.available_balance.equals("0")){
                   ...
                   // it?.message?.let { it1 -> ConstantUtils.showToast(requireActivity(), it1) }
                    ...
                    binding.tvNoOfProfiles.text = it.data?.consumed_duration ?: ""
        ...
        //sub List
        viewModel.getSubscriptionV2List("3")
